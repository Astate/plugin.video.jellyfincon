...
def populateWidgetItems(items_url, widget_type, override_select_action=None):
    ...
    for item in result:
        ...
        if item_type == "Series":
            playurl = "plugin://plugin.video.jellyfincon/?item_id=" + item_id + '&mode=SHOW_MENU' + session_id
        elif select_action == "1":
            playurl = "plugin://plugin.video.jellyfincon/?item_id=" + item_id + '&mode=PLAY' + session_id
